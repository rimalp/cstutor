...
function displayDetailCourse(course){
	...
	getInfoBoxes("Projects", course.projects, projectDiv);
	var studentDiv = document.createElement("div");
	getInfoBoxes("Students", course.students, studentDiv);
...
function displayDetailProject(project){
	...
	var studentDiv = document.createElement("div");
	getInfoBoxes("Students", project.course.students, studentDiv);
...
function displayDetailStudent(student){
	...
	var projectDiv = document.createElement("div");
	getInfoBoxes("Projects", student.course.projects, projectDiv);
...
function getInfoBoxes(title, array, parent){
	...
	for(var i=0; i<array.length; i++){
		...
		div.innerHTML = "<img class='info_content' width='50' height='50'> \
				 <a class='info_content' href='#'>" + current.title + "</a>";
...
function showDetailView(){
	...
	detail_view.style.height = "95%";
	canvas.style.visibility = "hidden";
}

function showCanvas(){
	detail_view.style.visibility = "hidden";
	detail_view.style.height = "0%";
