...
app.post('/update_prompt', function(req, res){
	database.updatePrompt(req.body.id, req.body.projectName, req.body.courseName, req.body.courseYear, req.body.courseSemester, req.body.text, req.body.requiresInput, req.body.eventType, req.body.frequency, function(err, result){
		sendPostResponse(req, res, err, result);
	});
});

app.post('/delete_prompt', function(req, res){
	database.deletePrompt(req.body.id, function(err, result){
		sendPostResponse(req, res, err, result);
	});
});

app.post('/responses', function(req, res){
	database.getResponsesForGraph(req.body.graphId, function(err, result){
		sendPostResponse(req, res, err, result);
	});
});

app.post('/create_response', function(req, res){
...
app.post('/create_graph', function(req, res){
	...
	database.createGraph(req.body.graphInfo, req.body.studentEmail, req.body.courseName, req.body.courseYear, req.body.courseSemester, req.body.projectName, function(err, result){
		sendPutRequest(req, res, err, result);
	});
});
...
app.post('/delete_node', function(req, res){
	database.deleteNode(req.body.nodeInfo.id, function(err, result){
		sendPutRequest(req, res, err, result);
	});
});
