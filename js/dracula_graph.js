...
Graph.Renderer.Raphael.prototype = {
	...
	var selfReff = this;
		...
		var ellipse2 = r.ellipse(0, 19, 3, 3).attr({fill: "black", stroke: "black", "stroke-width": 2});
		var ellipse3 = r.ellipse(0, -19, 3, 3).attr({fill: "black", stroke: "black", "stroke-width": 2});
		
		ellipse.mousedown(mousedown1);
		var mousedown2 = function(e){
			firstNode = node;
			firstEllipse = ellipse2;
			ellipse2.attr("stroke", "red");
		};
		ellipse2.mousedown(mousedown2);
		var mousedown3 = function(e){
			graphRef.addEdge(firstNode.id, node.id, {directed: true});
			selfReff.draw();
			secondNode = node;
			firstEllipse.attr("stroke", "black");
		};
		ellipse3.mousedown(mousedown3);
